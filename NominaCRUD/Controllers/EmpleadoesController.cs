...
namespace NominaCRUD.Controllers
{
    public class EmpleadoesController : Controller
    {
        ...
        public EmpleadoesController(RecorverNominaContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmpleadoId,Nombre,Cedula,Codigo,Departamento,SalarioBase,FechaIngreso")] Empleado empleado)
        {
